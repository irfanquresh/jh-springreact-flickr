...
describe('Photo e2e test', () => {
  ...
  const photoSample = { title: 'deposit Direct', image: 'Li4vZmFrZS1kYXRhL2Jsb2IvaGlwc3Rlci5wbmc=', imageContentType: 'unknown' };
  ...
  describe('new Photo page', () => {
    ...
    it('should create an instance of Photo', () => {
      cy.get(`[data-cy="title"]`).type('withdrawal Tunisia').should('have.value', 'withdrawal Tunisia');
