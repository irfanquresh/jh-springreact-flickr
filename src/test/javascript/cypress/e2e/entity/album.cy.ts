...
describe('Album e2e test', () => {
  ...
  const albumSample = { title: 'Account' };
  ...
  describe('new Album page', () => {
    ...
    it('should create an instance of Album', () => {
      cy.get(`[data-cy="title"]`).type('Metrics Soap transmit').should('have.value', 'Metrics Soap transmit');
      ...
      cy.get(`[data-cy="created"]`).type('2022-09-25T09:36').blur().should('have.value', '2022-09-25T09:36');
