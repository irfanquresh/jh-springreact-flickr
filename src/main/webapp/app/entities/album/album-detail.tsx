    ...
    <Row>
      <Col md="8">
        <h2 data-cy="albumDetailsHeading">
          <Translate contentKey="flickrappApp.album.detail.title">Album</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="title">
              <Translate contentKey="flickrappApp.album.title">Title</Translate>
            </span>
          </dt>
          <dd>{albumEntity.title}</dd>
          <dt>
            <span id="description">
              <Translate contentKey="flickrappApp.album.description">Description</Translate>
            </span>
          </dt>
          <dd>{albumEntity.description}</dd>
          <dt>
            <span id="created">
              <Translate contentKey="flickrappApp.album.created">Created</Translate>
            </span>
          </dt>
          <dd>{albumEntity.created ? <TextFormat value={albumEntity.created} type="date" format={APP_DATE_FORMAT} /> : null}</dd>
          <dt>
            <Translate contentKey="flickrappApp.album.user">User</Translate>
          </dt>
