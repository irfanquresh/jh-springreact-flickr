  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="flickrappApp.album.home.createOrEditLabel" data-cy="AlbumCreateUpdateHeading">
            <Translate contentKey="flickrappApp.album.home.createOrEditLabel">Create or edit a Album</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('flickrappApp.album.title')}
                id="album-title"
                name="title"
                data-cy="title"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('flickrappApp.album.description')}
              ...
              />
              <ValidatedField
                label={translate('flickrappApp.album.created')}
                id="album-created"
                name="created"
                data-cy="created"
                type="datetime-local"
              ...
              />
              <ValidatedField id="album-user" name="user" data-cy="user" label={translate('flickrappApp.album.user')} type="select">
                <option value="" key="0" />
                {users
