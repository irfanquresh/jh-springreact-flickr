  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="flickrappApp.photo.home.createOrEditLabel" data-cy="PhotoCreateUpdateHeading">
            <Translate contentKey="flickrappApp.photo.home.createOrEditLabel">Create or edit a Photo</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('flickrappApp.photo.title')}
                id="photo-title"
                name="title"
                data-cy="title"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('flickrappApp.photo.description')}
              ...
              />
              <ValidatedBlobField
                label={translate('flickrappApp.photo.image')}
                id="photo-image"
                name="image"
                data-cy="image"
                isImage
              ...
              />
              {metadataRows}
              <ValidatedField id="photo-album" name="album" data-cy="album" label={translate('flickrappApp.photo.album')} type="select">
                <option value="" key="0" />
                {albums
              ...
              <ValidatedField label={translate('flickrappApp.photo.tag')} id="photo-tag" data-cy="tag" type="select" multiple name="tags">
                <option value="" key="0" />
                {tags
